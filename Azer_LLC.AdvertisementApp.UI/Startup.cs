using AutoMapper;
using Azer_LLC.AdvertisementApp.UI.Mappings.AutoMapper;
using Azer_LLC.AdvertisementApp.UI.Models;
using Azer_LLC.AdvertisementApp.UI.ValidationRules;
using Azer_LLC.AdvertisementApp.Business.DependencyResolvers.Microsoft;
...
namespace Azer_LLC.AdvertisementApp.UI
{
    ...
    .AddCookie(opt => {
        opt.Cookie.Name = "AzerLLC_Cookie";
        ...
        opt.AccessDeniedPath = new Microsoft.AspNetCore.Http.PathString("/Account/AccessDenied");
            ...
            services.AddAutoMapper(typeof(UserCreateModelProfile));
        }
